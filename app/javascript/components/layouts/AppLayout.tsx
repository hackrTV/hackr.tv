...
const IdentityMatrixPage = lazy(() => import('~/components/pages/grid/IdentityMatrixPage').then(m => ({ default: m.IdentityMatrixPage })))
  ...
  return (
    <Suspense fallback={<LoadingPage message="Loading page..." />}>
      <Routes>
        ...
        <Route path="/grid/identity" element={<ProtectedRoute><IdentityMatrixPage /></ProtectedRoute>} />
        <Route path="/grid/reset_password/:token" element={<ProtectedRoute><ResetPasswordPage /></ProtectedRoute>} />
        {/* Hackr Logs routes */}
